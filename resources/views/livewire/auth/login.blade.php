                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-info text-gradient">{{ __('Welcome to Virbility') }}</h3>
                            <p class="mb-0">{{ __('Platform Edukasi berbasis VR untuk Pelatihan Keterampilan Kerja bagi Penyandang Disabilitas')}}<br></p>
                        </div>
                        <div class="card-body">
