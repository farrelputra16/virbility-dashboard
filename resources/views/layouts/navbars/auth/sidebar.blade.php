<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="../assets/img/logo-virbility.png" class="navbar-brand-img h-250" alt="...">
            <span class="ms-3 font-weight-bold">Virbility Dashboard</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tables' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Blogs and Article</span>
                </a>
            </li>
            <li class="nav-item">
