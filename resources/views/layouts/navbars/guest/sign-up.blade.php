<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand d-flex flex-column font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ route('home') }}">
            Virbility Dashboard
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-flex flex-row d-none">
                <li class="nav-item">
                    <a class="nav-link text-light me-2" href="{{ auth()->user() ? route('static-sign-up') : route('sign-up') }}">
                        <i class="fas fa-user-circle opacity-6 text-light me-1"></i>
                        Sign Up
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light me-2" href="{{ auth()->user() ? route('sign-in') : route('login') }}">
